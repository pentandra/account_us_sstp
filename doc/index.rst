...
third-party tax information provider to make a sales tax computation for even
something as basic as a quote, not to mention the security or privacy concerns
of giving a third-party transactional and product information about your
business. Second, it may be that not all states compensate CSPs, and depending
upon your sales volume, this may be a cheaper solution in the long or even
short run—or at least an alternative to consider. Third, this module builds
upon Tryton's existing tax models, including tax rules and reporting. Fourth,
it is hoped that this project can make more people aware of the Streamlined
Sales Tax Project, which seems to be a sensible model for taxes in the United
States (as far as sales taxes are sensible). The hope is to encourage those
states that are not yet on board, to get on board, or in some way make their
tax data available to the public in open formats.
